...
public class HomeFragmentPresenter extends BasePresenter<AppContract.HomeFragmentView>{

    private AppApi appApi;

    @Inject
    public HomeFragmentPresenter(ErrorListener errorListener, AppApi appApi) {
        super(errorListener);
        this.appApi = appApi;
    }
