...
public class SellerDetailPresenter extends BasePresenter<AppContract.SellerDetailView> {

    private AppApi appApi;

    @Inject
    public SellerDetailPresenter(ErrorListener errorListener, AppApi appApi) {
        super(errorListener);
        this.appApi = appApi;
    }
}
